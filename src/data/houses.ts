...
export const realHouses: House[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Просторный двухэтажный дом 231 м² с мансардой в СНТ «Новое», Энгельс. Участок 10 соток, тёплый пол, скважина, рассрочка и ипотека.",
    description:
      "Продаётся просторный двухэтажный дом 231 м² с мансардным этажом в СНТ «Новое» на участке 10 соток. Ровный прямоугольный участок, кадастровый номер 64:38:050302:957. Подключено электричество, водяной тёплый пол, скважина и канализация. Готовы каркас лестницы на второй этаж, окна ПВХ и входная металлическая дверь. В ближайшее время будет проведён газ. Цена — 52 тыс. ₽/м² с готовыми коммуникациями. Рассрочка от застройщика через эскроу-счёт, семейная ипотека. Аккредитованы в Сбербанке, Россельхозбанке, ДОМ.РФ, Альфа-Банке, Росбанке и Почта Банке.",
    highlights: [
      "231 м² с мансардой",
      "Тёплый пол по дому",
      "Рассрочка через эскроу",
      "Семейная ипотека",
      "Газ скоро будет проведён",
    ],
    specs: {
      floors: 2,
      landCategory: "СНТ",
