...
export const realHousesUnsorted: House[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Дом 87 м² в СНТ «Малинки», ул. Покровское Заречье: 3 спальни, 2 с/у, гардероб, кухня-гостиная 35 м² с выходом на террасу. Участок 7,5 соток, скважина и выгребная яма.",
    description:
      "Продаётся одноэтажный дом 87 м² в СНТ «Малинки» (г. Энгельс), ул. Покровское Заречье. Планировка: кухня-гостиная 35,15 м² с выходом на террасу, 3 спальни (15,12 + 12,04 + 12,04 м²), 2 санузла, гардероб, котельная и тамбур. Участок 7,5 соток: скважина и выгребная яма. Подходит под семейную ипотеку.",
    highlights: [
