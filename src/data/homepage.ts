...
export const seoIntroData = {
  ...
  paragraphs: [
    "Мы строим и продаём одноэтажные и двухэтажные частные дома с участком, газом, водой, канализацией и электрической разводкой по дому (подключение выполняется отдельно). Большинство объектов продаются вместе с земельным участком — после покупки не нужно искать землю.",
