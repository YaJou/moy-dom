...
export const searchFilters = {
  ...
  rooms: ["Любое количество", "1", "2", "3", "4", "5+"],
  bedrooms: ["Любое количество", "1", "2", "3", "4", "5+"],
  land: ["Любой", "от 8 соток", "от 10 соток"],
  readiness: ["Любая", "Готов к заселению", "На стадии строительства"],
  floors: ["Любая", "1 этаж", "2 этажа"],
  gas: ["Любой", "Подключен", "По границе участка", "Планируется"],
...
export const featuresData = [
  {
    id: 1,
    icon: "flame",
    title: "Газ уже подключен",
    description:
      "Газовая магистраль проходит по участку — не нужно искать подрядчиков и ждать подключения месяцами. Остаётся оформить договор с газовой службой.",
  },
  {
    id: 2,
    icon: "thermometer",
    title: "Тёплый пол по всему дому",
    description:
      "Водяной тёплый пол заложен в проект — комфортно зимой, нет батарей у стен, равномерный прогрев во всех комнатах.",
  },
  {
    id: 3,
    icon: "map",
    title: "Участок входит в стоимость",
    description:
      "Земля уже оформлена и входит в цену дома. Не нужно отдельно искать участок, проводить межевание и согласовывать границы.",
  },
  {
    id: 4,
    icon: "landmark",
    title: "Помогаем оформить ипотеку",
    description:
      "Работаем с ведущими банками, помогаем собрать документы и получить одобрение. Семейная и стандартная ипотека.",
  },
  {
    id: 5,
    icon: "building",
  ...
  },
  {
    ...
    description:
      "5 лет на конструктив, 2 года на инженерные системы. Все условия прописаны в договоре — без устных обещаний.",
  },
];
...
export const faqData = [
  {
    ...
    answer:
      "В стоимость входит сам дом, земельный участок, скважина, канализация, а также оформление всех документов.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer:
      "Скважина, выгребная яма. Подробности по коммуникациям расскажем на просмотре.",
  },
];
