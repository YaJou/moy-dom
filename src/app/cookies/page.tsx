          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-dark sm:text-base">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                ...
                (счётчик 111093512, вебвизор и карта кликов). Загружается только
                после нажатия «Принять» в баннере cookie.
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                <strong>Принять</strong> — разрешаете Яндекс.Метрику и связанные
