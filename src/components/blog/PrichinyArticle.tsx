    ...
    <article className="ja-page pr-page">
      <div className="container-main">
        ...
        <div className="pr-layout">
          ...
          <section className="pr-full pr-compare-wrap" id="sravnenie">
              ...
              <div className="pr-compare-cards">
                <figure className="pr-compare-card">
                  ...
                  <figcaption>
                    ...
                    <p>
                      Больше свободы в проекте. Потребуется организовать
                      проектирование, работы и контроль.
                    </p>
                ...
                <figure className="pr-compare-card">
                  ...
                  <figcaption>
                    ...
                    <p>
                      Можно осмотреть результат. Придётся выбирать из
                      существующих планировок и проверить состояние дома.
                    </p>
                    <span className="ja-caption">Иллюстрация</span>
                  </figcaption>
                </figure>
          ...
          <section className="pr-col pr-section" id="prichiny">
          ...
          <section className="pr-full pr-section" id="budget">
          ...
          <section className="pr-col pr-section" id="proverka">
          ...
          <section className="pr-col pr-section" id="stroit">
          ...
          <section className="pr-col pr-section" id="ipoteka-note">
            <p className="ja-p">
              Если рассматриваете покупку с кредитом, условия программы и
              требования к конкретному дому нужно уточнить до решения о покупке.{" "}
          ...
          <section className="pr-col pr-section" id="faq">
          ...
          <div className="pr-full">
            ...
            <section className="pr-cta">
              <div className="pr-cta-copy">
                ...
                <p>
                  На месте проще оценить комнаты, участок и объём оставшихся
                  работ. Выберите интересующий дом и согласуйте просмотр.
                </p>
              </div>
              <ViewingForm
